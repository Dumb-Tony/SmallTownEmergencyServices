# Small Town Emergency Services dev server - started by play.bat (double-click friendly).
#
...
#
# Ports 8381-8390, chosen to sit clear of the Chameleon server (8321-8330) and the
...
Write-Host ""
Write-Host "  SMALL TOWN EMERGENCY SERVICES is running at $url" -ForegroundColor Green
